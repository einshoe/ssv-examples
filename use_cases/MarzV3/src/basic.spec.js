...
import {addToSorted, removeAddAndFindMedian, medianFilter} from "../src/Utils/methods";
...
describe("Tests for the linked lists and median filter", () => {
    it("Linked List - addToSorted test", () => {
        const head = [null, null];
        const entries = [5,6,2,4,0,8,7,7,1];
        for (let i = 0; i < entries.length; i++) {
            addToSorted(head, entries[i]);
        }
