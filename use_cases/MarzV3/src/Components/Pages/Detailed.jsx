...
class Detailed extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log("->Detailed.componentDidMount: remote file in detailed=",remote_file, this.displayMarz(),window.marz_configuration.layout,this.props.detailed);
        if (remote_file!=null) {
            let files = [];
    ...
    render() {
        console.log("->Detailed.render", this, this.props.detailed);
