...
import {addFiles, addJson, getjsonFitsFileList} from "../Stores/Data/Actions";
...
class Sidebar extends React.Component {
    ...
    render() {
        console.log("RENDER SIDE BAR",globalConfig.available);
        for (let key in globalConfig.available) {
            console.log("RENDER",key);
        }
        console.log("RENDER SIDE BAR DONE",globalConfig.available);
        return (
                    ...
                    }
                    {
                        !isDetailed(this.props) || !this.props.ui.sidebarSmall ? (
                            <div className="top-spacing">
                                ...
                                <div className="top-spacing">
                                    <Button block color="light" size="sm" onClick={() => addJson(1)}>
                                        Test Server 1
                                    </Button>
                                </div>
                                <div className="top-spacing">
                                    <Button block color="light" size="sm" onClick={() => addJson(2)}>
                                        Test Server 2
                                    </Button>
                                </div>
                                <div className="top-spacing">
                                    <Button block color="light" size="sm" onClick={() => addJson(3)}>
                                        Test Server 3
                                    </Button>
                                </div>
                                {<div className="top-spacing">
