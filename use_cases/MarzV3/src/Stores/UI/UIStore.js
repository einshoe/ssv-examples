...
import {templateManager as templatesService} from "../../AutoRedshift/Lib/TemplateManager";
import {getFit, getQuasarFFT, getStandardFFT, matchTemplate} from "../../AutoRedshift/Lib/autoredshiftmethods";
import {
    ...
    reduce(state, action) {
        switch (action.type) {
            ...
            case UIActionTypes.SET_VARIANCE:
                ...
                console.log("SSV IN SET_VARIANCE",state.ssv);
